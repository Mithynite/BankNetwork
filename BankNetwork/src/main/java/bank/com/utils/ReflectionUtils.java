package bank.com.utils;

import bank.com.annotations.Column;
import bank.com.annotations.Id;
import bank.com.annotations.Table;
...
public class ReflectionUtils {
    ...
    private static Object convertValue(Class<?> type, String value) {
        if (type == int.class || type == Integer.class) {
            ...
            try {
                return DATE_FORMAT.parse(value); // Parse date format if field is Date type
            } catch (Exception e) {
            ...
            // If it's an Enum, ensure we handle this correctly
